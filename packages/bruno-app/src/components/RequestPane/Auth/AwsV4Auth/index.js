...
const AwsV4Auth = ({ item, collection, updateAuth, request, save }) => {
  ...
  return (
    <StyledWrapper className="mt-2 w-full">
      <label className="block mb-1">{t('REQUEST_PANE.AUTH.ACCESS_KEY_ID')}</label>
      ...
      <label className="block mb-1">{t('REQUEST_PANE.AUTH.SECRET_ACCESS_KEY')}</label>
      ...
      <label className="block mb-1">{t('REQUEST_PANE.AUTH.SESSION_TOKEN')}</label>
      <div className="single-line-editor-wrapper mb-3">
        <SingleLineEditor
      ...
      <label className="block mb-1">{t('REQUEST_PANE.AUTH.SERVICE')}</label>
      <div className="single-line-editor-wrapper mb-3">
        <SingleLineEditor
      ...
      <label className="block mb-1">{t('REQUEST_PANE.AUTH.REGION')}</label>
      <div className="single-line-editor-wrapper mb-3">
        <SingleLineEditor
      ...
      <label className="block mb-1">{t('REQUEST_PANE.AUTH.PROFILE_NAME')}</label>
