    ...
    <StyledWrapper ref={wrapperRef} data-testid="variables-editor">
      <div className="variables-main">
        <div className="variables-scroll" data-testid="variables-scroll-container">
          <VariablesSection
            icon={IconBolt}
            title={t('VARIABLES_EDITOR.RUNTIME_VARIABLES')}
          ...
          >
            {runtimeRows.length > 0 ? (
              ...
              <div className="muted text-xs px-2 py-1">{t('VARIABLES_EDITOR.NO_RUNTIME_VARIABLES')}</div>
            )}
          </VariablesSection>

          <VariablesSection
            icon={IconDatabase}
            title={t('VARIABLES_EDITOR.ENVIRONMENT_VARIABLES')}
          ...
          >
            {!environment ? (
              <div className="muted text-xs px-2 py-1">{t('VARIABLES_EDITOR.NO_ENVIRONMENT_SELECTED')}</div>
            ) : envRows.length > 0 ? (
              <VariablesTable
              ...
              <div className="muted text-xs px-2 py-1">{t('VARIABLES_EDITOR.NO_ENVIRONMENT_VARIABLES')}</div>
            )}
          </VariablesSection>
        </div>
      </div>
