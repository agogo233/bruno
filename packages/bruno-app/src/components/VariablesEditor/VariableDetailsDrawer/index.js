    ...
    <StyledWrapper data-testid="variable-details-drawer">
      <div className="panel-header">
        <div className="panel-title">
          ...
          <span className="section-badge" data-testid="variable-details-section">({t(section === 'runtime' ? 'VARIABLES_EDITOR.RUNTIME' : 'VARIABLES_EDITOR.ENVIRONMENT')})</span>
        </div>
        <button
          type="button"
          className="close-button"
          onClick={onClose}
          title={t('VARIABLES_EDITOR.CLOSE')}
