      ...
      <div className="row-actions">
        {isObjectValue && !isMasked && (
          <button
            ...
            title={t('VARIABLES_EDITOR.OPEN_IN_DRAWER')}
            aria-label={t('VARIABLES_EDITOR.OPEN_OBJECT_IN_DRAWER')}
        ...
        {secret && (
          <button
            ...
            title={revealed ? t('VARIABLES_EDITOR.HIDE_SECRET') : t('VARIABLES_EDITOR.SHOW_SECRET')}
            aria-label={revealed ? t('VARIABLES_EDITOR.HIDE_SECRET') : t('VARIABLES_EDITOR.SHOW_SECRET')}
        ...
        <button
          ...
          onClick={handleCopy}
          title={t('VARIABLES_EDITOR.COPY_VALUE')}
