        ...
        icon={(
          <button className="filter-dropdown-trigger" title={title} data-testid="filter-dropdown-trigger">
            ...
            <span className="filter-summary">
              {activeFilterCount === filterEntries.length ? t('DEVTOOLS.FILTER_DROPDOWN.ALL') : `${activeFilterCount}/${filterEntries.length}`}
            </span>
      ...
      >
        <FilterMenu data-testid="filter-dropdown-menu">
          <div className="filter-dropdown-header">
            ...
            >
              {allFiltersEnabled ? t('DEVTOOLS.FILTER_DROPDOWN.HIDE_ALL') : t('DEVTOOLS.FILTER_DROPDOWN.SHOW_ALL')}
            </button>
          </div>
