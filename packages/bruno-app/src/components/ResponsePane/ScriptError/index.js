        ...
        <div className="script-error-header">
          ...
          <div className="script-error-header-actions">
            <button
              ...
              onClick={handleCopy}
              aria-label={t('RESPONSE_PANE.SCRIPT_ERROR.COPY_SCRIPT_ERROR')}
              title={copied ? t('RESPONSE_PANE.SCRIPT_ERROR.COPIED') : t('RESPONSE_PANE.SCRIPT_ERROR.COPY_SCRIPT_ERROR')}
            >
            ...
            <button
              ...
              aria-label={isExpanded ? t('RESPONSE_PANE.SCRIPT_ERROR.COLLAPSE_SCRIPT_ERROR') : t('RESPONSE_PANE.SCRIPT_ERROR.EXPAND_SCRIPT_ERROR')}
              title={isExpanded ? t('RESPONSE_PANE.SCRIPT_ERROR.COLLAPSE') : t('RESPONSE_PANE.SCRIPT_ERROR.EXPAND')}
            >
              {isExpanded ? <IconArrowsDiagonalMinimize2 size={16} strokeWidth={1.5} /> : <IconArrowsDiagonal size={16} strokeWidth={1.5} />}
            </button>

            {onClose && (
              <button className="icon-button flex-shrink-0 cursor-pointer" data-testid="script-error-close" onClick={onClose} aria-label={t('RESPONSE_PANE.SCRIPT_ERROR.CLOSE_ERROR')}>
