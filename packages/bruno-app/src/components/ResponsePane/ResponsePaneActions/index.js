...
const MenuIcon = forwardRef((props, ref) => {
  ...
  return (
    <StyledMenuIcon
      ref={ref}
      title={t('RESPONSE_PANE.ACTIONS.MORE_ACTIONS')}
      {...props}
    >
...
const ResponsePaneActions = ({ item, collection, responseSize, selectedFormat, selectedTab, data, dataBuffer }) => {
  ...
  const gqlMenuItems = [
    {
      id: 'copy-response',
      label: t('RESPONSE_PANE.ACTIONS.COPY_RESPONSE'),
    ...
    },
    {
      ...
      label: t('RESPONSE_PANE.ACTIONS.DOWNLOAD_RESPONSE'),
    ...
    {
      id: 'clear-response',
      label: t('RESPONSE_PANE.ACTIONS.CLEAR_RESPONSE'),
    ...
    {
      id: 'change-layout',
      label: t('RESPONSE_PANE.ACTIONS.CHANGE_LAYOUT'),
  ...
  const menuItems = [
    ...
    {
      id: 'save-response',
      label: t('RESPONSE_PANE.ACTIONS.SAVE_RESPONSE'),
