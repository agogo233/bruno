...
const DigestAuth = ({ collection }) => {
  ...
  return (
    <StyledWrapper className="mt-2 w-full">
      <label className="block mb-1">{t('COLLECTION_SETTINGS.AUTH_DIGEST.USERNAME')}</label>
      ...
      <label className="block mb-1">{t('COLLECTION_SETTINGS.AUTH_DIGEST.PASSWORD')}</label>
