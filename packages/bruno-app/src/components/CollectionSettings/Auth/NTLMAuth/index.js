...
const NTLMAuth = ({ collection }) => {
  ...
  return (
    <StyledWrapper className="mt-2 w-full">
      <label className="block mb-1">{t('COLLECTION_SETTINGS.AUTH_NTLM.USERNAME')}</label>
      ...
      <label className="block mb-1">{t('COLLECTION_SETTINGS.AUTH_NTLM.PASSWORD')}</label>
      ...
      <label className="block mb-1">{t('COLLECTION_SETTINGS.AUTH_NTLM.DOMAIN')}</label>
