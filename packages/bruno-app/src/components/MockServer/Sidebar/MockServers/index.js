    ...
    <>
      ...
      >
        ...
        >
          <ActionIcon
            ...
            label={t('MOCK_SERVER.SIDEBAR.TOGGLE_RESPONSES')}
        ...
        <div className="pr-2">
          <MenuDropdown items={menuItems} placement="bottom-end">
            <ActionIcon label={t('MOCK_SERVER.SIDEBAR.ACTIONS_LABEL')} className="mock-server-actions">
      ...
      {expanded ? (
        responses.length > 0 ? (
          ...
          <div className="pl-9 empty-mock-server-message">{t('MOCK_SERVER.SIDEBAR.NO_MOCK_RESPONSES')}</div>
        )
      ) : null}
    </>
  );
