    ...
    return (
      <StyledWrapper>
        <div className="text-xs text-center placeholder py-4">
          <div>{t('SIDEBAR.API_SPECS.NO_SPECS')}</div>
          <div className="mt-2">
            <OpenLink /> {t('SIDEBAR.API_SPECS.API_SPEC')}.
          </div>
        </div>
      </StyledWrapper>
    );
