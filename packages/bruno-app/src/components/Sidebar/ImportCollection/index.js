...
const ImportCollection = ({ onClose, handleSubmit }) => {
  ...
  return (
    <Portal>
      <Modal size="md" title={t('SIDEBAR.IMPORT_COLLECTION.TITLE')} hideFooter={true} handleCancel={onClose} dataTestId="import-collection-modal">
          ...
          <div className="flex w-full mb-6">
            <div className="flex justify-start w-full tabs">
              ...
              >
                ...
                {t('SIDEBAR.IMPORT_COLLECTION.FILE')}
              </div>
              <div
              ...
              >
                ...
                {t('SIDEBAR.IMPORT_COLLECTION.GIT_REPOSITORY')}
              </div>
              <div
              ...
              >
                ...
                {t('SIDEBAR.IMPORT_COLLECTION.URL')}
              </div>
            </div>
          </div>
